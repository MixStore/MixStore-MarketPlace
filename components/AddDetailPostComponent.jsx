  ...
  {categoryList.map((item, index) => (
    <Picker.Item key={index} label={item?.name} value={item?.name} />
            ...
            <TouchableOpacity onPress={() => {
                    ...
                    <Ionicons name='arrow-forward-circle-outline' size={36} color={COLORS.primary} />
                    <Text style={modern.iconButtonText}>Adicionar mais Detalhes</Text>
                </TouchableOpacity>
</View>
